...
struct MarkMomentIntent: AppIntent {
    ...
    static var description = IntentDescription("Record a timestamped moment in NOX.")
...
/// Surfaces NOX's intents to Siri, Spotlight, and the Shortcuts gallery without any user setup.
