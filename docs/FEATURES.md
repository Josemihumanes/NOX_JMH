...
NOX no longer ships an in-app Support or donations screen. Attribution, non-affiliation, and
medical-disclaimer copy live in the About/legal surfaces instead, keeping the app focused on
