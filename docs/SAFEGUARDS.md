...
**1. No donation / crypto solicitation in NOX.**
NOX does not ship an in-app donation/support surface, and the fork should not paste crypto
addresses into issues, PRs, comments, app copy, or release automation. If historical upstream
material mentions donations, treat it as archival context, not an active feature.
