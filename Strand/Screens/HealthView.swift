...
/// captioned with its in-range state. Re-skinned to the locked NOX component
        ...
        VStack(alignment: .leading, spacing: NoopMetrics.gap) {
            ...
            NoopCard(tint: StrandPalette.chargeColor) {
                VStack(alignment: .leading, spacing: NoopMetrics.cardInnerSpacing) {
                    ...
                    // Route the manual offload kick through the unified NOX button system so the
...
private struct VitalsSection: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: NoopMetrics.gap) {
            ...
            Text("Once NOX has 14 nights of history, in-range compares each vital to your own baseline (approximate, not medical advice); until then, typical adult ranges apply.")
                .font(StrandFont.footnote)
                .foregroundStyle(StrandPalette.textTertiary)
                .fixedSize(horizontal: false, vertical: true)
        }
