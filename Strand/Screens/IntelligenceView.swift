...
/// Intelligence — NOX's own recovery/strain/sleep scores, computed on-device from raw strap data
...
struct IntelligenceView: View {
    ...
    var body: some View {
        ...
        ScreenScaffold(title: "Intelligence",
                       subtitle: "NOX scores your charge, effort and rest itself: on-device, no cloud.",
                       lazy: true,
        ...
        NoopCard(padding: 18, tint: StrandPalette.chargeColor) {
            VStack(alignment: .leading, spacing: NoopMetrics.cardInnerSpacing) {
                HStack {
                    ...
                    // The REAL source of the day's dashboard headline, not a hard-coded "NOX-computed".
                    // The By-Day numbers are always NOX's on-device scores, but when an import covers the
