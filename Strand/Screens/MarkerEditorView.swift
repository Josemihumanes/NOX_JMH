...
// free-text — NEVER a NOX-shipped range. Blood pressure is a PAIRED marker (systolic +
...
// shown back verbatim — NOX defines no ranges and asserts no normality.
        ...
        VStack(alignment: .leading, spacing: NoopMetrics.gap) {
            ...
            NoopCard {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    Text("NOX never fills this in. It only shows back exactly what you type from your own report.")
                        .font(StrandFont.footnote)
                        .foregroundStyle(StrandPalette.textTertiary)
