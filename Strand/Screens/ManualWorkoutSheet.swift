...
struct ManualWorkoutSheet: View {
    ...
    // NOX doesn't enumerate still saves exactly as typed (#519). Typing filters the catalogue
...
struct StartWorkoutSheet: View {
    ...
    init(title: String? = nil, subtitle: String? = nil, actionVerb: String? = nil,
        ...
        self.explainer = subtitle
            ?? String(localized: "Pick a sport. NOX records HR, peak, average and effort from the live feed.")
